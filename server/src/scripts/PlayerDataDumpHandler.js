...
(async () => {
    await mongoose.connect("mongodb://localhost/dungeonzDB", { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true })
        .catch((err) => {
    ...
    // Ensure this is the same schema as in AccountModel.js.
