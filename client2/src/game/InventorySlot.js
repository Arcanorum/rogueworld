class InventorySlot {
    ...
    fill(catalogueEntry, durability, maxDurability) {
        ...
        /** @type {Slot} */
        const guiSlot = window.gameScene.GUI.inventoryBar.slots[this.slotKey];
    ...
    empty() {
        ...
        window.gameScene.GUI.inventoryBar.slots[this.slotKey].icon.style.visibility = "hidden";
        window.gameScene.GUI.inventoryBar.slots[this.slotKey].durability.style.visibility = "hidden";
        window.gameScene.GUI.inventoryBar.slots[this.slotKey].equipped.style.visibility = "hidden";
        window.gameScene.GUI.inventoryBar.slots[this.slotKey].addButton.style.visibility = "hidden";
        ...
        if (this.craftingComponent !== null) {
            window.gameScene.craftingManager.removeComponent(this.craftingComponent.number);
        }
    }
    ...
    updateDurability(value) {
        ...
        window.gameScene.GUI.inventoryBar.slots[this.slotKey].durability.src = `assets/img/gui/hud/durability-meter-${meterNumber}.png`;
    }
}
