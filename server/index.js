...
async function init() {
    ...
    if (fs.existsSync("../client2/src/assets/images") === false) {
        fs.mkdirSync("../client2/src/assets/images");
    }
    ...
    await extrudeTilesetToImage(16, 16, "./map/tilesets/ground.png", "../client2/src/assets/images/ground.png");
    await extrudeTilesetToImage(16, 16, "./map/tilesets/statics.png", "../client2/src/assets/images/statics.png");
