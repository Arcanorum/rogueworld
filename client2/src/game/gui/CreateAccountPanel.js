...
class CreateAccountPanel extends PanelTemplate {
    constructor() {
        super(document.getElementById("create_account_panel"), 440, 420,
            window.dungeonz.getTextDef("Create account panel: name"), "gui/hud/exit-icon");
        ...
        topInfoContainer.innerText = window.dungeonz.getTextDef("Create account panel: info");
        ...
        this.usernameInput.placeholder = window.dungeonz.getTextDef("Enter username");
        ...
        this.passwordInput.placeholder = window.dungeonz.getTextDef("Enter password");
        ...
        this.createAccountText.innerText = window.dungeonz.getTextDef("Create account");
    ...
    async createAccountPressed() {
        ...
        window.window.ws.sendEvent("create_account", {
