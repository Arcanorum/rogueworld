...
class AccountPanel extends PanelTemplate {
    constructor() {
        super(document.getElementById("account_panel"), 440, 340, dungeonz.getTextDef("Account panel: name"), "gui/hud/exit-icon");
        ...
        topInfoContainer.innerText = dungeonz.getTextDef("Account panel: info");
        ...
        this.currentPasswordInput.placeholder = dungeonz.getTextDef("Current password");
        ...
        this.newPasswordInput.placeholder = dungeonz.getTextDef("New password");
        ...
        this.acceptText.innerText = dungeonz.getTextDef("Accept");
