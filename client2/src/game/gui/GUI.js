...
class GUI {
    constructor(GAME) {
        ...
        */
        ...
        this.defenceIcon.onmouseover = () => {
            game.GUI.defenceTooltip.style.visibility = "visible";
        };
        this.defenceIcon.onmouseout = () => {
            game.GUI.defenceTooltip.style.visibility = "hidden";
        };

        this.hitPointIcon.onmouseover = () => {
            game.GUI.hitPointTooltip.style.visibility = "visible";
        };
        this.hitPointIcon.onmouseout = () => {
            game.GUI.hitPointTooltip.style.visibility = "hidden";
        };

        this.energyIcon.onmouseover = () => {
            game.GUI.energyTooltip.style.visibility = "visible";
        };
        this.energyIcon.onmouseout = () => {
            game.GUI.energyTooltip.style.visibility = "hidden";
        };

        this.gloryIcon.onmouseover = () => {
            game.GUI.gloryTooltip.style.visibility = "visible";
        };
        this.gloryIcon.onmouseout = () => {
            game.GUI.gloryTooltip.style.visibility = "hidden";
        };

        this.avatarIcon.onmouseover = () => {
            game.GUI.avatarTooltip.style.visibility = "visible";
        };
        this.avatarIcon.onmouseout = () => {
            game.GUI.avatarTooltip.style.visibility = "hidden";
        };
        this.avatarIcon.onclick = () => {
            if (game.GUI.statsPanel.isOpen === true) {
        ...
        this.tasksIcon.onmouseover = () => {
            game.GUI.tasksTooltip.style.visibility = "visible";
        };
        this.tasksIcon.onmouseout = () => {
            game.GUI.tasksTooltip.style.visibility = "hidden";
        };
        this.tasksIcon.onclick = () => {
            if (game.GUI.tasksPanel.isOpen === true) {
        ...
        this.mapIcon.onmouseover = () => {
            game.GUI.mapTooltip.style.visibility = "visible";
        };
        this.mapIcon.onmouseout = () => {
            game.GUI.mapTooltip.style.visibility = "hidden";
        };

        this.clanIcon.onmouseover = () => {
            game.GUI.clanTooltip.style.visibility = "visible";
        };
        this.clanIcon.onmouseout = () => {
            game.GUI.clanTooltip.style.visibility = "hidden";
        };
        this.clanIcon.onclick = () => {
            if (game.GUI.clanPanel.isOpen === true) {
        ...
        this.inventoryIcon.onmouseover = () => {
            game.GUI.inventoryTooltip.style.visibility = "visible";
        };
        this.inventoryIcon.onmouseout = () => {
            game.GUI.inventoryTooltip.style.visibility = "hidden";
        };
        this.inventoryIcon.onclick = () => {
            window.window.ws.sendEvent("pick_up_item");
        };

        this.exitIcon.onmouseover = () => {
            game.GUI.exitTooltip.style.visibility = "visible";
        };
        this.exitIcon.onmouseout = () => {
            game.GUI.exitTooltip.style.visibility = "hidden";
        };
        this.exitIcon.onclick = () => {
            if (game.player.isLoggedIn) {
                if (game.GUI.accountPanel.isOpen === true) {
                    game.GUI.accountPanel.hide();
                }
                else {
                    game.GUI.accountPanel.show();
                }
            }
            else if (game.GUI.createAccountPanel.isOpen === true) {
                game.GUI.createAccountPanel.hide();
            }
            else {
                game.GUI.createAccountPanel.show();
            }
        };

        this.discordIcon.onmouseover = () => {
            game.GUI.discordTooltip.style.visibility = "visible";
        };
        this.discordIcon.onmouseout = () => {
            game.GUI.discordTooltip.style.visibility = "hidden";
        };

        this.wikiIcon.onmouseover = () => {
            game.GUI.wikiTooltip.style.visibility = "visible";
        };
        this.wikiIcon.onmouseout = () => {
            game.GUI.wikiTooltip.style.visibility = "hidden";
        };
    ...
    updateGloryCounter(value) {
        const difference = value - window.gameScene.player.glory;
        if (difference > 0) {
