...
/**
 * A wrapper around the core Phaser sprite, for some common things that might be used by any entity
 * sprites. Avoids having to modify the Phaser sprite prototype.
 */
...
Sprite.setupAnimations = () => { };

Sprite.addAnimationSet = () => { };
